...
import logging
import time
from rag.etl.extractors import extract_all, WEB_SOURCES, RSS_SOURCES, PDF_DIR
...
def run_pipeline(
    ...
    raw_docs = extract_all(
        pdf_folder=pdf_folder,
        web_urls=web_urls,
        rss_feeds=rss_feeds,
        rss_max_age_days=14,  # only ingest articles from the last 14 days
    )
